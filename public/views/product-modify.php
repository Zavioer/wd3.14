        ...
        <div class="content column-center-center">
            ...
            <form action="/productModify" method="POST" class="form-base-desktop">
                ...
                <div class="form-input-wrapper">
                    <input type="text" required name="name" placeholder="Name" class="text-input-base" value="<?= $product->getName() ?>">
                    <input type="text" required name="upc" placeholder="UPC" class="text-input-base" value=<?= $product->getUpc(); ?>>
                    <textarea class="textarea-base" name="description" placeholder="Description" id="description"><?= $product->getDescription(); ?></textarea>
                    <input type="text" required name="price" placeholder="Price" class="text-input-base" value=<?= $product->getPrice(); ?>>
                    ...
                    <input type="text" required name="uom" placeholder="uom" class="text-input-base" value="<?= $product->getUom(); ?>">
